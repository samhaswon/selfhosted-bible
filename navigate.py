...
class NavigatePassage(FlaskForm):
    """
    FlaskForm for Bible passage navigation.
    Should be used with navigate.js on the frontend to make a dynamic dropdown
...
class NavigateVersion(FlaskForm):
    ...
    """
    select_version: SelectField = \
        SelectMultipleField('Select version',
