...
class NIV2011(Bible):
    def __init__(self) -> None:
        ...
        # Caching
        try:
            with open('bibles/json_bibles/niv2011.json', 'r') as cache_in:
        ...
        self.__API_URL: str = "https://bolls.life/get-chapter/NIV2011/"

    def get_passage(self, book: str, chapter: int) -> dict:
        """
        Gets a chapter of the NIV (2011)
    ...
    def __api_return(self, book: str, chapter: int) -> None:
        ...
        if chapter % 2 == 0:
            try:
                # Normal save
                with open("bibles/json_bibles/niv2011.json", "w") as bible_save:
