...
class BollsBible(Bible):
    """Bolls Bible class. Used for Bibles pulled from the bolls.life API"""
    def __init__(self, cache_name: str, api_name: str) -> None:
        """
        Gets a JSON formatted dictionary of a bolls.life passage.
        :param cache_name: Name prefix of the cache file.
        :param api_name: Name of the version in the API.
        """
        super().__init__()
        self.__compress_cache = CompressCache(cache_name)
        ...
        self.__api_url: str = f"https://bolls.life/get-chapter/{api_name}/"

    def get_passage(self, book: str, chapter: int) -> dict:
        """
        Gets a chapter of the version.
