...
class NASB1995(Bible):
    def __init__(self) -> None:
        ...
        # Caching
        try:
            with open('bibles/json_bibles/nasb1995.json', 'r') as cache_in:
        ...
        self.__API_URL: str = "https://bolls.life/get-chapter/NASB/"

    def get_passage(self, book: str, chapter: int) -> dict:
        """
        Gets a chapter of the NASB (1995)
    ...
    def __api_return(self, book: str, chapter: int) -> None:
        ...
        if chapter % 2 == 0:
            try:
                # Normal save
                with open("bibles/json_bibles/nasb1995.json", "w") as bible_save:
