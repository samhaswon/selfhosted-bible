...
def create_app() -> Flask:
    ...
    bibles = {'AKJV': akjv_obj, 'AMP': amp_obj, 'ASV': asv_obj, 'BSB': bsb_obj, 'CSB': csb_obj, 'ESV': esv_obj,
              'GNV': gnv_obj, 'KJV': kjv_obj, 'LSV': lsv_obj, 'MSG': msg_obj, 'NASB 1995': nasb_1995_obj, 'NET': net_obj,
