...
async function updateiframe(iframe, bookSelector, chapterSelector, versionSelector) {
    iframe.src = `${base}/embed?version=${versionSelector.value}&book=${bookSelector.value}&chapter=${chapterSelector.value}`;
}
...
if (bookSelect) {
    ...
    try {
        ...
        for (let i = 0; i < 4; i++) {
            bookSelectors[i].addEventListener('change', function() {
                updateiframe(
                    bibleFrames[i],
                    bookSelectors[i],
                    chapterSelectors[i],
            ...
            chapterSelectors[i].addEventListener('change', function() {
                updateiframe(
                    bibleFrames[i],
                    bookSelectors[i],
                    chapterSelectors[i],
            ...
            versionSelectors[i].addEventListener('change', function() {
                updateiframe(
                    bibleFrames[i],
                    bookSelectors[i],
                    chapterSelectors[i],
